...
- Can be extended with new data types and functions via C or C++.
- It has a standard library that is described [here](https://github.com/peter-catalin/python-playground.git).

# Syntax

```python
# This is a comment in Python
# Python only has single-line comments
```
